...
if res ~= 200 then
print('\n\27[1;31m￤ Your Token is Incorrect Please Check it!\n￤ آلتوگن آلذي آدخلته‏‏ غير صـحيح , تاكد مـنه‏‏ ثم حآول مـجددآ!')
create_config()
end
...
if SUDO_USER == '' then
print('\n\27[1;31m￤ You Did not Enter USERID !\n￤ لم تقوم بآدخآل شـي , يرجى آلآنتبآہ‏‏ وآدخل آلآن ايدي آلمطور آلآسـآسـي')
create_config(Token)
end 
...
print('\n\27[1;31m￤ Conect is Failed !\n￤ حدث خطـآ في آلآتصـآل بآلسـيرفر , يرجى مراسلة‏‏ مـطـور آلسـورس ليتمـگن مـن حل المشكله‏‏ في آسـرع وقت مـمـگن . !')
create_config(Token)
end
...
─────▀██▀─────
┊ＭᎯẊ ‿ @aao1_1
تم تطوير وبرمجة السورس من قبل رودكر
┊@rosnw1  ‿ @aao1_1
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
...
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*•تم رفع آلنسـخه‏‏ الاحتياطية\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(max..'group:ids')..'* 🌿\n✓')
	end
